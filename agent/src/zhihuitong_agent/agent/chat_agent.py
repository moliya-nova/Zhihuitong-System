...
from zhihuitong_agent.agent.prompt.chat_prompt import (
    CLASSIFY_PROMPT,
    FALLBACK_SUMMARY,
...
from zhihuitong_agent.agent.prompt.rag_prompt import RAG_CONTEXT_PREFIX
from zhihuitong_agent.agent.prompt.search_prompt import SEARCH_CONTEXT_PREFIX
from zhihuitong_agent.agent.prompt.system_prompt import SYSTEM_DEFAULT
